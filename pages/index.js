...
function AuthLogo() {
  return (
    <div className="auth-logo" style={{justifyContent:"center",marginBottom:28}}>
      <svg width="160" height="60" viewBox="0 0 160 60" fill="none" xmlns="http://www.w3.org/2000/svg"><polygon points="24,3 10,30 22,30 14,57 36,24 24,24 34,3" fill="#2196F3"/><text x="46" y="27" font-family="'Plus Jakarta Sans',Arial,sans-serif" font-size="18" font-weight="800" fill="#F5945C" letter-spacing="2">EASY</text><text x="46" y="50" font-family="'Plus Jakarta Sans',Arial,sans-serif" font-size="18" font-weight="800" fill="#F5945C" letter-spacing="2">WORK</text></svg>
    </div>
  );
}
      ...
      <div className="shell">
        <aside className="sidebar">
          <div className="logo" style={{padding:"8px 10px 16px"}}>
            <svg width="120" height="44" viewBox="0 0 120 44" fill="none" xmlns="http://www.w3.org/2000/svg"><polygon points="18,2 8,22 16,22 10,42 26,18 18,18 26,2" fill="#2196F3"/><text x="34" y="20" font-family="'Plus Jakarta Sans',Arial,sans-serif" font-size="13" font-weight="800" fill="#F5945C" letter-spacing="1.5">EASY</text><text x="34" y="37" font-family="'Plus Jakarta Sans',Arial,sans-serif" font-size="13" font-weight="800" fill="#F5945C" letter-spacing="1.5">WORK</text></svg>
          </div>
